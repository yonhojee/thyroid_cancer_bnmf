...
ld_index_start = (as.numeric(args[1]) - 1) * 200 + 1
ld_index_stop = ld_index_start + 199 #ld_index_stop = ld_index_start
...
saveRDS(permuted_EO_matrix,
        paste0("/bNMF/permutation_66loci_k5/",annot_name,"_permuted_EO_matrix_",ld_index_stop/200,".rds"))
